...
class Main {
  ...
  public static void main(String[] args) throws IOException {
	Roster testRoster = new Roster("roster1.txt"); 
//	testRoster.addPlayer("Ryan Meuth", 0.1, 0.2);
//	testRoster.addPlayer("Phill Miller", 0.2, 0.1);
	System.out.println("Roster size: " + testRoster.getPlayerCount());
	testRoster.printAllPlayers();
